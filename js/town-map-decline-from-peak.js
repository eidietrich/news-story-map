...
var colorTicks = [1,0.9,0.7,0.5,0.25,0];
var colorScale = d3.scaleLinear()
  .range(['#1d91c0','#78c679','#ffc418','#ff8200','#f8171c','#a52a2a'])
  .domain(colorTicks)
...
function drawCities(points){
  ...
  cities.append('circle')
    ...
    .attr('fill', function(d){
      ...
      return colorScale(d.properties.fractionOfPeak);
    })
...
function addLegends(){
  ...
  var colorLegend = d3.legendColor()
    ...
    // .cells(censusYears)
    .cells(colorTicks)
    .title('Percent of peak population (2010)')
